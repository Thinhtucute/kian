...
import 'package:anki2/helpers/dictionary/dict_entry.dart';
...
class FSRSReviewService {
  ...
  static Future<Map<String, dynamic>> processReview(int entSeq, bool isGood,
    ...
    if (currentType == 0) {
      ...
      debugPrint(
          'New card: Initializing stability to ${newStability.toStringAsFixed(2)} and difficulty to ${newDifficulty.toStringAsFixed(2)}');
    }
    ...
    // Learning -> Review
      ...
      // Use standard FSRS processReview instead of custom calculations
